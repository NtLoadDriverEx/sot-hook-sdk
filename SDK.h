...
struct AController {
	...
	char pad_0000[0x0440]; //0x0000
	class ACharacter* Character; //0x0440
	char pad_0480[0x70]; //0x04B8 - 0x448 = 0x70
	APlayerCameraManager* PlayerCameraManager; //0x4B8
	char pad_04f8[0xFD9]; // 0x0508
	bool IdleDisconnectEnabled; // 0x1491(0x0001)
...
struct AAthenaGameState {
	char pad[0x0610];
	UINT64* WindService; // 0x0610
	UINT64* PlayerManagerService; // 0x0618
	AShipService* ShipService; // 0x0620
	UINT64* WatercraftService; // 0x0628
	UINT64* TimeService; // 0x0630
	UINT64* WaterService; // 0x0638
	UINT64* StormService; // 0x0640
	ACrewService* CrewService; // 0x0648
	UINT64* ContestZoneService; // 0x0650
	UINT64* ContestRowboatsService; // 0x0658
	class AIslandService* IslandService; // 0x0660(0x0008)
...
public:
	...
	char pad1[0x448]; // 0x28
	APlayerState* PlayerState;  // 0x0448
	char pad2[0x10]; // 0x0450
	AController* Controller; // 0x0460
	char pad3[0x28]; // 0x4B0
	USkeletalMeshComponent* Mesh; // 0x0490
	UCharacterMovementComponent* CharacterMovement; // 0x0498
	char pad4[0x3B8]; // 0x04A0
